...
const features = [
	{
		...
		description:
			"Paste any URL and get a short, shareable link in under a second.",
	},
	{
		icon: BarChart3,
	...
	},
	{
		...
		description:
			"Securely view, filter, copy, and manage all your shortened links.",
	},
];
				...
				<div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8 pt-12 pb-16 sm:pt-16 sm:pb-24">
					<div className="text-center max-w-3xl mx-auto mb-10 animate-fade-in">
						...
						<p className="text-lg sm:text-xl text-muted leading-relaxed max-w-2xl mx-auto">
							Create short, memorable links in seconds and track how they
							perform.
						</p>
					</div>
				...
				<div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8 py-16">
					...
					<div className="text-center mt-12">
						...
						<p className="text-xs text-muted mt-3">
							Sign up to save links, use custom slugs, and access your
							dashboard.
						</p>
					</div>
				</div>

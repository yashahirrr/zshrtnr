          ...
          <div className="hidden md:flex items-center gap-1">
            {visibleLinks.map((link) => (
              <Link
                ...
                activeProps={{ className: 'px-3 py-2 text-sm font-medium text-foreground bg-accent rounded-lg' }}
              >
                {link.label}
              </Link>
            ))}
            ...
            <div className="flex flex-col gap-1">
              {visibleLinks.map((link) => (
                <Link
                  ...
                  onClick={() => setMobileOpen(false)}
                  activeProps={{ className: 'px-3 py-2.5 text-sm font-medium text-foreground bg-accent rounded-lg' }}
                >
                  {link.label}
                </Link>
              ))}
